...
class AgentReporterTest {
  ...
  void completedSessionWithSpecs(@TempDir java.nio.file.Path stateDir) throws Exception {
    ...
    assertEquals("sing/snap-20260302", report.branch());
        ...
        new ScriptedShellExecutor()
            ...
            .onOk(
                ...
                "{\"task\":\"implement API\",\"started_at\":\""
                    + startedAt
                    + "\",\"branch\":\"sing/api\",\"log_path\":\"/home/dev/.sing/agent.log\"}")
            .onOk(
        ...
        new ScriptedShellExecutor()
            ...
            .onOk(
                ...
                "{\"task\":\"implement auth\",\"started_at\":\""
                    + startedAt
                    + "\",\"branch\":\"sing/snap\",\"log_path\":\"/home/dev/.sing/agent.log\"}")
            .onFail("cat /home/dev/guardrail-triggered.yaml", "No such file")
            .onOk("git -C /home/dev/workspace log -1 --format=%ct", "\n")
  ...
  void reportToMapContainsAllFields() {
    var report =
        new AgentReporter.Report(
            ...
            "sing/snap",
            List.of(
                new ai.singlr.sing.config.Spec(
    ...
    assertEquals("sing/snap", map.get("branch"));
  ...
  private static SingYaml buildConfig(String taskFile) {
    return new SingYaml(
        CONTAINER,
        null,
        ...
        null,
        new SingYaml.Agent(
            "claude-code", true, "sing/", true, null, null, null, taskFile, null, null, null),
        null,
        new SingYaml.Ssh("dev", null));
  }

  private static SingYaml buildConfigNoSpecsDir() {
    return new SingYaml(
        CONTAINER,
        null,
        new SingYaml.Resources(4, "12GB", "150GB"),
