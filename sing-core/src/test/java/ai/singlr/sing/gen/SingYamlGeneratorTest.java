...
class SingYamlGeneratorTest {
  ...
  void includesGitSection() {
    var config =
        new SingYaml(
            ...
            null,
            null,
            new SingYaml.Git("Uday", "uday@singlr.ai", "token", null),
            null,
            null,
            null,
            null,
    ...
    assertTrue(yaml.contains("name: Uday"));
    assertTrue(yaml.contains("email: \"uday@singlr.ai\""));
  ...
  void includesGitSshKeyWhenSet() {
    var config =
        new SingYaml(
            ...
            null,
            null,
            new SingYaml.Git("Uday", "uday@singlr.ai", "ssh", "~/.ssh/id_ed25519"),
            null,
            null,
            null,
            null,
  ...
  void includesReposSection() {
    var config =
        new SingYaml(
            ...
            null,
            List.of(
                new SingYaml.Repo("https://github.com/singlr-ai/helios.git", "helios", "main"),
                new SingYaml.Repo("https://github.com/singlr-ai/scim-sql.git", "scim-sql", null)),
            null,
            null,
            null,
            null,
    ...
    assertTrue(yaml.contains("url: \"https://github.com/singlr-ai/helios.git\""));
    assertTrue(yaml.contains("path: helios"));
    assertTrue(yaml.contains("branch: main"));
    assertTrue(yaml.contains("path: scim-sql"));
    var lines = yaml.lines().toList();
    var scimIdx = -1;
    for (var i = 0; i < lines.size(); i++) {
      if (lines.get(i).contains("scim-sql")) {
        scimIdx = i;
        break;
      }
    }
  ...
  void hasCommentHeader() {
    ...
    assertTrue(yaml.startsWith("# sing.yaml"));
    assertTrue(yaml.contains("Generated by `sing project init`"));
  }
