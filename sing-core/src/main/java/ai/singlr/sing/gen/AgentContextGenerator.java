...
/**
 * Generates agent context files and SECURITY.md from {@link SingYaml} configuration. Produces the
...
public final class AgentContextGenerator {
   ...
   *
   * @deprecated Use {@link #generateFiles(SingYaml)} which supports all agent types.
   */
  @Deprecated
  public static String generateClaudeMd(SingYaml config) {
   ...
   */
  static List<AgentCli> resolveTargetAgents(SingYaml config) {
  ...
  static String generateAgentContextFile(AgentCli agent, SingYaml config) {
    var sb = new StringBuilder();
    sb.append("# ")
        .append(agent.contextFileName())
        .append(" \u2014 Project Context for AI Coding Agent\n");
    sb.append("# Auto-generated by `sing project create`. Edit freely.\n");
  ...
  static String generateContextBody(SingYaml config) {
    var sb = new StringBuilder();
    ...
    sb.append("\n## Environment\n");
    sb.append("This workspace runs inside an Incus container managed by `sing`.\n");
  ...
  static String generateSecurityMd() {
    return """
        ...
        # Auto-generated by `sing project create`. Edit freely.
  ...
  static String languageConventions(SingYaml.Runtimes runtimes) {
    if (runtimes == null) {
      return "";
    }
    var sb = new StringBuilder();
  ...
  private static void appendAutonomousSection(StringBuilder sb, SingYaml config) {
    if (config.agent() == null) {
      return;
    }
    ...
    if (config.agent().specsDir() != null) {
      sb.append(step++)
          .append(". Update the spec status to \"done\" in ")
  ...
  private static String serviceDisplayName(String name, SingYaml.Service service) {
  ...
  private static String serviceNotes(SingYaml.Service service) {
